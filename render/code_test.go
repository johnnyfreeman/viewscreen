...
func TestDetectLanguageFromPath(t *testing.T) {
	tests := []struct {
		...
		// Go
		{"go file", "main.go", "go"},
		{"go file with path", "/home/user/project/internal/server/handler.go", "go"},

		// Python
		{"python file", "script.py", "python"},
		{"python with path", "src/utils.py", "python"},

		// JavaScript
		{"js file", "app.js", "javascript"},
		{"js with path", "frontend/index.js", "javascript"},

		// TypeScript
		{"ts file", "types.ts", "typescript"},
		{"ts with path", "src/components/Button.ts", "typescript"},
		...
		{"ruby with path", "lib/models/user.rb", "ruby"},

		// Rust
		{"rust file", "main.rs", "rust"},
		{"rust with path", "src/lib.rs", "rust"},

		// Java
		{"java file", "Main.java", "java"},
		{"java with path", "com/example/App.java", "java"},
		...
		// Shell
		{"sh file", "script.sh", "bash"},
		{"bash file", "deploy.bash", "bash"},
		...
		{"yml file", "docker-compose.yml", "yaml"},

		// XML
		{"xml file", "pom.xml", "xml"},

		// HTML
		{"html file", "index.html", "html"},
		{"htm file", "page.htm", "html"},

		// CSS
		{"css file", "styles.css", "css"},
		{"scss file", "app.scss", "scss"},

		// Markdown
		{"md file", "README.md", "markdown"},

		// Case insensitivity
		{"uppercase extension", "file.GO", "go"},
		{"mixed case", "File.Py", "python"},
		...
		{"path with dots", "my.file.name.go", "go"},
	}
